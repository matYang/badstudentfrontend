 var EnterInfoSearchView= Backbone.View.extend({
 	...
 	render:function(){
 		...
 		$('#enterInfoSearch-modal-main').append("<div class = 'moda-close' id = 'enterInfoSearch-modal-closeButton'>X</div>");
 		$('#enterInfoSearch-modal-main').append("<input class = 'modal-input' id = 'enterInfoSearch-modal-email'/>");
 		$('#enterInfoSearch-modal-main').append("<input class = 'modal-input' id = 'enterInfoSearch-modal-phone'/>");
 		$('#enterInfoSearch-modal-main').append("<input class = 'modal-input' id = 'enterInfoSearch-modal-qq'/>");
 		$('#enterInfoSearch-modal-main').append("<input class = 'modal-input' id = 'enterInfoSearch-modal-twitter'/>");
 		$('#enterInfoSearch-modal-main').append("<input class = 'modal-input' id = 'enterInfoSearch-modal-selfDefined'/>");
